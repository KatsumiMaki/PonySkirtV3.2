Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/ef052f212c03ed446abb940494f3d549"
{
	Properties
	{
 ...
 #define _RIMSTYLE_POIYOMI 
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				viewDotNormal = pow(viewDotNormal, float(1.77));
				if (float(0) && float(0))
				{
