Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/4fc3c98bb8216584ca0c3722452644bc"
{
 ...
 #define _RIMSTYLE_UTS2 
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				float3 rimColor = float3(poiThemeColor(poiMods, float4(0.0409152,0.496933,1,1).rgb, float(0)));
				...
				float _RimLightPower_var = pow(_RimArea_var, exp2(lerp(3, 0, float(0.481))));
