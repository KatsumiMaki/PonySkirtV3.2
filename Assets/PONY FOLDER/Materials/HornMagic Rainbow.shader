...
Shader "aaa"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float mulTime100 = _Time.y * -1.0;
			float3 hsvTorgb93 = HSVToRGB( float3(( ( tex2DNode89 * 0.3 ) + mulTime100 + i.uv_texcoord.xy.y ).r,1.0,1.0) );
			...
			float4 temp_cast_4 = ((clampResult10*1.0 + -0.4)).xxxx;
			float4 temp_output_55_0 = CalculateContrast(3.0,temp_cast_4);
			...
			o.Emission = ( ( float4( hsvTorgb93 , 0.0 ) + tex2DNode89 ) + temp_output_55_0 + clampResult58 ).rgb;
...
/*ASEBEGIN
Version=18935
919;367;1114;473;2518.204;815.2147;2.853454;True;True
...
Node;AmplifyShaderEditor.SamplerNode;89;-1627.568,-171.0887;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;1;[HideInInspector];Create;True;0;0;0;False;0;False;-1;b9b58e34ad210da4fa975ced7b82cdd7;b9b58e34ad210da4fa975ced7b82cdd7;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;57;268.4302,830.1923;Inherit;False;3;0;COLOR;0,0,0,0;False;1;FLOAT;2;False;2;FLOAT;-0.5;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;100;-1468.758,-475.6897;Inherit;False;1;0;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleNode;101;-1335.715,-334.782;Inherit;False;0.3;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;102;-1631.494,-343.4357;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;99;-1083.03,-322.6071;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.HSVToRGBNode;93;-891.3322,-359.4123;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;103;-485.5676,-343.2285;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;1;609.9636,-277.206;Inherit;False;Property;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.9339623,0.3127893,0.7708302,0;0.9339623,0.3127892,0.7708302,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CD3A5E8EAA283FE788747B6F1727715C1FE845A4